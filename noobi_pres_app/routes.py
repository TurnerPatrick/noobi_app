...
from noobi_pres_app import app, db

# Import specific packages from flask
from flask import render_template,request, redirect, url_for

# Import Our Form(s)
from noobi_pres_app.forms import UserInfoForm, LoginForm, PostForm

# Import of Our Model(s) for the Database
from noobi_pres_app.models import User, Post, check_password_hash
...
@app.route('/games')
def gamesRoute():
    games = ['League of Legends', 'Red Dead Redemption', 'Ghost of Tsushima']
    return render_template('games.html',list_names = games)
